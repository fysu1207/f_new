...
var CheckoutComponent = (function () {
    ...
    function CheckoutComponent(authService, title, router, getMenu, datePipe, winRef) {
        ...
        this.datePipe = datePipe;
        this.winRef = winRef;
        this.p_key = 'rzp_live_qNI6V5maLBak44';
...
var MenuComponent = (function () {
    ...
    MenuComponent.prototype.ngOnInit = function () {
        ...
        $(document).ready(function () {
            ...
            var mm_cur_time = __WEBPACK_IMPORTED_MODULE_7_moment__(new Date());
...
module.exports = __webpack_require__.p + "gift.2cea368adbccaf1cd9dd.jpg";
